...
\newcommand{\tto}{\ensuremath{\textrm{t}\bar{\textrm{t}}}\xspace}
...
\newcommand{\altl}{\ensuremath{\alpha^{lep}_{T}}}
\newcommand{\srb}{\ensuremath{\sfrac{S}{\sqrt{B}}}\xspace}%<TW date="30/10/2010">
%\newcommand{\Et}{E_{T}}
...
\def\hslash{{\hbox{$H$\kern-0.7em\lower-.05ex\hbox{/}\kern0.10em}}}

\def\hslashhead{{\hbox{$H$\kern-0.7em\lower-.05ex\hbox{/}\kern0.10em}}}

\def\MHT{\mbox{$\hslash_\text{T}$}\xspace}
\def\MHTh{\mbox{$\hslashhead_\text{T}$}\xspace}
...
\newcommand{\stc}{\ensuremath{\mathbf{x}}}
