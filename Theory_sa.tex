...
Quantum Chromodynamics (QCD) is the relevant quantum field theory that describes the dynamics of the strong force. The strong force of symmetry group SU(3) has a conserved quantity called colour charge, and only particles which carry it are affected. Quarks have colour, while leptons do not, and unlike the photon in electromagnetism, the gluons that mediate the force carry the charge also. This leads to the self-interactions that govern the behaviour of QCD. Separation of two charges gives rise to a potential energy, which increases linearly as the charges are moved further apart. The coupling constant of the strong force, $\alpha_{S}$
